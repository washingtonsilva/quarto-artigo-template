...
modelsummary(capm_ford,
             output = "latex",         # formato de saída compatível com a compilação LaTeX do Quarto
             statistic = c("conf.int",
                           "e.p. = {std.error}",  # erro padrão
                           "t = {statistic}",      # estatística t
                           "p = {p.value}"),       # p-valor
             stars = FALSE,            # não adiciona asteriscos de significância
             gof_omit = "DF|Deviance|AIC|BIC|Log.Lik.|RMSE",  # omite medidas de ajuste não relevantes
